  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        ...
        <VideoSection videoSrc={gestaltVideo2} sectionId="kontaktunterbrechungen" title="Kontaktunterbrechungen" position="left" content={<>
              <p className="mb-3 text-[sidebar-accent-foreground] text-secondary-foreground">Kontaktunterbrechungen sind Schutzmechanismen, die uns einst geholfen haben, aber heute hindern.<strong className="text-accent font-semibold">Kontaktunterbrechungen</strong> sind Schutzmechanismen, 
