  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        ...
        <VideoSection videoSrc={gestaltVideo2} sectionId="kontaktunterbrechungen" title="Kontaktunterbrechungen" position="left" content={<>
              <p className="mb-3 text-primary-foreground text-[sidebar-accent-foreground]">Heilung geschieht, wenn wir Unvollendetes integrieren. Eine geschlossene Gestalt bringt inneren Frieden und lässt Sie wieder als „ganzes Selbst“ fühlen.<strong className="text-accent font-semibold">Kontaktunterbrechungen</strong> sind Schutzmechanismen, 
