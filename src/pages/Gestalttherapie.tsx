...
const VideoSection = ({
  ...
  return <section ref={sectionRef} id={sectionId} className="relative h-[350vh]">
    <div className="sticky top-0 h-screen w-full overflow-hidden">
      <video ref={videoRef} autoPlay loop muted playsInline preload={sectionId === 'hier-und-jetzt' ? 'none' : 'metadata'} className="absolute inset-0 w-full h-full object-cover object-center">
...
const Gestalttherapie = () => {
  return <div className="min-h-screen bg-background">
    ...
    <main className="pt-24">
      ...
      <VideoSection videoSrc={gestaltVideo} sectionId="offene-gestalt" title="Offene Gestalt" position="right" content={<>
        <p className="mb-3">
      ...
      <VideoSection videoSrc={gestaltVideo2} sectionId="kontaktunterbrechungen" title="Kontaktunterbrechungen" position="left" content={<>
        <p className="mb-3 text-[sidebar-accent-foreground] text-secondary-foreground">​<strong className="text-accent font-semibold">Kontaktunterbrechungen</strong> sind die Schutzmechanismen,
      ...
      <VideoSection videoSrc={gestaltVideo3} sectionId="hier-und-jetzt" title="Geschlossene Gestalt" position="center" content={<>
        <p className="mb-3">
          Heilung geschieht, wenn wir Unvollendetes integrieren. Eine <strong className="text-accent font-semibold">geschlossene Gestalt</strong> bringt inneren Frieden und lässt dich wieder als „ganzes Selbst" fühlen.
        </p>
        <p className="text-primary font-medium text-center mt-4 text-sm md:text-base">
          Erfüllung, Frieden und Ruhe kehrt ein.
        </p>
      </>} />
      ...
      <section className="py-12 md:py-32 bg-off-white">
        <div className="container mx-auto px-4">
          <AnimatedSection className="max-w-5xl mx-auto">
            <motion.img src={gestaltKontaktzyklus} alt="Der Gestalt-Kontaktzyklus" className="w-full rounded-xl mb-6 md:mb-12" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
            ...
            <motion.div className="p-5 md:p-14 rounded-2xl bg-secondary" initial={{
              ...
              <motion.div className="p-4 md:p-6 rounded-xl border-l-4 border-primary bg-primary/[0.08]" initial={{
                ...
                <p className="text-foreground/80 text-sm md:text-base leading-relaxed">
                  <strong className="text-primary">Unterbrechungen</strong> dieses Zyklus können zu psychischen und körperlichen Beschwerden führen.
      ...
      <section className="py-12 md:py-32 bg-background">
        <div className="container mx-auto px-4">
          <AnimatedSection className="max-w-5xl mx-auto">
            <motion.img src={ressourcenUnterstuetzung} alt="Ressourcen und Unterstützung für den Prozess" className="w-full rounded-xl mb-6 md:mb-8" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
            ...
            <motion.div className="p-5 md:p-14 rounded-2xl bg-secondary" initial={{
              ...
              <p className="text-foreground/80 text-base md:text-lg leading-relaxed md:leading-loose mb-6 md:mb-10">
                Im therapeutischen Prozess nutzen wir Ressourcen um den Veränderungsprozess zu unterstützen, wobei verschiedene <strong className="text-primary">Ressourcen zur Stabilisierung</strong> dienen.
              </p>
          ...
          <StaggerContainer className="max-w-2xl mx-auto">
            ...
            <AnimatedItem>
              <p className="text-white/85 text-base md:text-lg mb-6 md:mb-10">
                Vereinbare ein kostenloses Kennenlerngespräch oder ruf einfach durch, um herauszufinden, ob eine Zusammenarbeit sinnvoll ist.
              </p>
            </AnimatedItem>
            <AnimatedItem>
              <a href="/kontakt">
