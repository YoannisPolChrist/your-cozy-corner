...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background overflow-x-clip">
    ...
    <main id="main-content" className="overflow-x-clip">
      {/* 
        High-End Curtain Reveal 
        Hero stays sticky in the background, while the rest of the content slides over it.
      */}
      ...
      <div className="relative z-10 bg-off-white rounded-t-[2.5rem] md:rounded-t-[3.5rem] shadow-[0_-20px_60px_rgba(0,0,0,0.3)] transform-gpu">
        {/* Meet Johannes Section - Overlapping Organic Card */}
        <section className="relative z-10 pt-8 sm:pt-12 pb-16 sm:pb-20 md:pb-28 overflow-x-clip">
                ...
                <div className="grid md:grid-cols-5 gap-10 md:gap-14 items-center">
                  ...
                  <motion.div initial={{
                    ...
                    <div className="relative group">
                      ...
                      <div className="absolute inset-0 rounded-[2rem] transition-all duration-700 group-hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.4)]" style={{
                      ...
                      <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] aspect-[4/5] bg-neutral-900 group">
                        ...
                        <motion.img alt="Johannes Christ – Gestalttherapeut und Coach, freundlicher Blickkontakt" className="relative z-20 w-full h-full object-cover object-top" style={{
                        ...
                        <div className="absolute inset-x-0 top-0 h-1/3 pointer-events-none z-30" style={{
        ...
        <AnimatedSection className="py-16 md:py-24 bg-off-white">
          <div className="container mx-auto px-4">
              ...
              {t.services.items.map((service, index) => {
                ...
                return <AnimatedItem key={index}>
                  <TiltCard tiltStrength={8} className="h-full">
                    <Link to={getLocalizedPath('/angebot')} onClick={scrollToTop} className="block h-full">
                      <Card className="p-7 sm:p-8 md:p-10 bg-off-white border border-accent/20 text-center transition-all duration-300 hover:shadow-xl group relative overflow-hidden h-full cursor-pointer">
                        ...
                        <div className="mb-5 sm:mb-6 flex justify-center">
                          <ThreeDIcon
                            ...
                            strokeWidth={1.5}
                            className="group-hover:[color:hsl(var(--primary))] transition-colors duration-300"
                          />
                        </div>
        ...
        <AnimatedSection className="py-20 md:py-32 bg-off-white overflow-hidden">
          <div className="container mx-auto px-4">
        ...
        <AnimatedSection className="py-28 md:py-36 bg-gradient-cta text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-teal-navy/30 z-0" />
