              ...
              <div className="grid md:grid-cols-5 gap-10 md:gap-14 items-center">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] aspect-[4/5]">
                      ...
                      <motion.img alt="Johannes Christ – Gestalttherapeut und Coach, freundlicher Blickkontakt" className="w-full h-full object-cover object-top" style={{
                        ...
                        duration: 0.6,
                        ease: [0.2, 0.8, 0.2, 1]
                      }} src="/lovable-uploads/4d576252-e1f7-400f-9da6-5468291bf00a.jpg" width={330} height={443} loading="eager" decoding="async" />
                ...
                <div className="md:col-span-3 order-2">
                  ...
                  <motion.p initial={{
                    ...
                    Optimalerweise in einem Rahmen, der hält und Sicherheit bietet. Dass dem meistens nicht so ist, ist natürlich selbstverständlich. Als Gestalttherapeut, Coach und M.Sc. Psychologie (i.A.) biete ich dir durch, Präsenz, Kompetenz und Schutz, den Raum, den es braucht, damit die Veränderung geschehen kann, die du dir wünschst!
                  </motion.p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-muted-foreground text-lg">
              Individuelle Räume für deine Entwicklung
            </p>
          </div>
            ...
            <StaggerContainer className="order-1 md:order-2">
              ...
              <AnimatedItem>
                <p className="text-muted-foreground text-lg mb-6 leading-loose">
                  Ich bin Johannes Christ, Gestalttherapeut, Coach und M.Sc. Psychologie (i.A.). Meine Arbeit basiert in einer Haltung von Achtung und Gewahrsein. In diesem Gewahrsein geschieht die Veränderung. Dies ist unser Ansatzpunkt. Mit langjähriger Erfahrung in Gestalttherapie und Coaching begleite ich dich auf dem Weg zu mehr Klarheit, Wohlbefinden und Erfüllung.
                </p>
              </AnimatedItem>
              <AnimatedItem>
