...
import { fadeUp, staggerContainer, cardStagger, cardItem, iconStagger, iconItem, viewportSettings, cinematicEase } from "@/lib/animations";
const services = [{
  icon: Heart,
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        <section className="pt-[68px] pb-32 bg-background">
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={viewportSettings} variants={staggerContainer} className="max-w-6xl mx-auto">
              <motion.h2 variants={fadeUp} className="font-heading text-[2.25rem] md:text-[3.1875rem] text-primary text-center mb-16">
                Meine Leistungen
              </motion.h2>
              ...
              <motion.div variants={cardStagger} className="grid md:grid-cols-3 gap-8 md:gap-16">
                ...
                return <motion.div key={index} variants={cardItem}>
        ...
        <section className="py-32 bg-primary">
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={viewportSettings} variants={staggerContainer} className="max-w-6xl mx-auto">
              <motion.p variants={fadeUp} className="text-[#c5a065] text-xs uppercase tracking-widest text-center mb-4">
                PHASE 1: DIE STANDORTBESTIMMUNG
              </motion.p>
              <motion.h2 variants={fadeUp} className="font-heading text-[2.25rem] md:text-[3.1875rem] text-primary-foreground text-center mb-16">
              ...
              <motion.div variants={iconStagger} className="grid md:grid-cols-3 gap-8 md:gap-16">
                ...
                return <motion.div key={index} variants={iconItem} className="text-center">
        ...
        <section className="py-32 bg-background">
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={viewportSettings} variants={staggerContainer} className="max-w-5xl mx-auto">
              <motion.h2 variants={fadeUp} className="font-heading text-[2.25rem] md:text-[3.1875rem] text-primary text-center mb-16">
              ...
              <motion.div variants={cardStagger} className="grid md:grid-cols-2 gap-8 md:gap-16">
                ...
                <motion.div variants={cardItem}>
                  <Card className="p-10 h-full bg-card border-none shadow-soft hover:shadow-teal transition-all duration-500">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-center mb-8">Psychologische Beratung, Gestalttherapie & Coaching. Ideal für akute Anliegen.</p>
        ...
        <section className="py-32 bg-off-white">
          <div className="container mx-auto px-4">
            <motion.div initial="hidden" whileInView="visible" viewport={viewportSettings} variants={staggerContainer} className="max-w-4xl mx-auto">
              <motion.h2 variants={fadeUp} className="font-heading text-[2.25rem] md:text-[3.1875rem] text-primary text-center mb-16">
                Flexible Formate
              </motion.h2>
        ...
        <section className="py-28 md:py-36 bg-gradient-cta relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.div initial="hidden" whileInView="visible" viewport={viewportSettings} variants={staggerContainer} className="max-w-2xl mx-auto">
