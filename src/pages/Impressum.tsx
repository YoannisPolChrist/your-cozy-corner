                ...
                <div className="space-y-12">
                    <section>
                        ...
                        <div className="typ-body text-foreground/80 space-y-1">
                            ...
                            {t.legal?.impressum?.angaben?.businessId && (
                                <p className="text-accent mt-2">{t.legal?.impressum?.angaben?.businessId}</p>
                            )}
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="typ-small text-foreground/70 leading-relaxed whitespace-pre-line">
