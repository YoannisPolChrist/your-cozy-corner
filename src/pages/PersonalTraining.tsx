            ...
            <main>
                ...
                <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pt-20">
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        <motion.div
                            className="absolute top-20 right-20 w-64 h-64 rounded-full bg-red-accent/10 blur-3xl"
                            animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
                            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
                        />
                        <motion.div
                            className="absolute bottom-20 left-20 w-96 h-96 rounded-full bg-red-accent/10 blur-3xl"
                            ...
                            <Link to={getLocalizedPath('/kontakt')} onClick={scrollToTop}>
                                <MagneticButton strength={0.3}>
                                    <div className="relative inline-block group mt-2">
                                        ...
                                        <motion.div
                                            className="absolute -inset-1 rounded-full bg-red-accent opacity-20 blur-lg group-hover:opacity-40 transition-opacity duration-700 pointer-events-none"
                ...
                <AnimatedSection className="py-24 md:py-32 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            <span className="text-red-accent text-sm uppercase tracking-[0.2em] font-medium mb-4 block">
                                {t.personalTraining.painPoints.label}
                            </span>
                            <h2 className="typ-h2 text-primary mb-4">
                                {t.personalTraining.painPoints.title}
                            </h2>
                        </div>
                ...
                {/* Approach Section with Image Carousel */}
                        ...
                        <div className="max-w-6xl mx-auto">
                            <StaggerContainer className="grid lg:grid-cols-2 gap-12 items-center">
                                ...
                                <AnimatedItem className="space-y-8">
                                    ...
                                    {/* Qualifications Card integrating directly */}
                                ...
                                {/* Right Side: Masonry Grid instead of Carousel */}
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-16">
                            ...
                            <p className="typ-body text-muted-foreground max-w-2xl mx-auto">
                                Evidenzbasierte Säulen für deine körperliche Transformation
                            </p>
                        </div>
                                ...
                                return (
                                    <AnimatedItem key={index}>
                                        <Card className="!py-6 !px-6 bg-white border border-red-accent/10 h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group shadow-sm">
                                            <div className="mb-6">
                                                <div className="w-16 h-16 rounded-2xl bg-primary/[0.03] flex items-center justify-center group-hover:bg-primary/[0.06] transition-colors">
                                                    <Icon className="w-8 h-8 text-red-accent group-hover:text-primary transition-colors duration-300" strokeWidth={1.5} />
                                                </div>
                                            </div>
                                            <span className="text-[10px] uppercase font-semibold block mb-2 text-red-accent tracking-tight">
                                                {service.subline}
                                            </span>
                ...
                <AnimatedSection className="py-24 md:py-32 bg-off-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <p className="typ-body text-muted-foreground max-w-2xl mx-auto">
                                Was andere über die Zusammenarbeit und Ergebnisse sagen.
                            </p>
                        </div>
                                ...
                                <AnimatedItem key={index}>
                                    <Card className="p-8 bg-white shadow-soft border-none h-full flex flex-col">
                                        <div className="flex gap-1 mb-6">
                                            {[...Array(5)].map((_, i) => (
                                                <Star key={i} className="w-5 h-5 text-red-accent fill-gold-accent" />
                                            ))}
                                        </div>
                ...
                <AnimatedSection className="py-20 md:py-28 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="typ-h3 font-heading text-red-accent mb-4">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.6, delay: 0.2 }}
                                className="mt-8 rounded-2xl overflow-hidden shadow-lg border border-red-accent/10 h-[350px] w-full"
                            >
                                <iframe
                ...
                {/* Pricing Section (matching Angebot.tsx's simplicity) */}
                        ...
                        <StaggerContainer className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                            ...
                            <AnimatedItem>
                                <Card className="p-8 bg-white shadow-soft border-none h-full relative overflow-hidden flex flex-col">
                                    <span className="text-xs uppercase tracking-wider text-red-accent font-semibold block mb-4">
                            ...
                            <AnimatedItem>
                                <Card className="p-8 bg-primary text-white shadow-xl h-full relative overflow-hidden border-0 flex flex-col">
                                    <div className="absolute top-4 right-4">
                                        <span className="px-3 py-1 bg-red-accent text-primary text-xs font-semibold rounded-full">
                                            {t.angebot.konditionen.intensiv.discount}
                                        </span>
                                    </div>
                                    <span className="text-red-accent text-xs uppercase tracking-wider font-semibold block mb-4">
                                    ...
                                    <p className="typ-small text-white/70 mb-4 line-through">
                                        Regulär {t.angebot.konditionen.einzelbegleitung.price}
                                    </p>
                                    <p className="typ-body text-white/85 mb-8 text-left whitespace-pre-line flex-grow">
                ...
                <AnimatedSection className="py-24 md:py-32 bg-gradient-cta text-white relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 text-center relative z-10">
                        <StaggerContainer className="max-w-2xl mx-auto">
                            <AnimatedItem>
                                <h2 className="typ-h2 mb-4 text-white">
                ...
                {/* Cross-Link to Gestalttherapie - Premium Transition */}
                <AnimatedSection className="py-24 md:py-32 bg-off-white relative overflow-hidden">
                    <div className="absolute inset-0 bg-primary/[0.02]" />
                    <div className="container mx-auto px-4 relative z-10">
                        <StaggerContainer className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-primary">
                                    ...
                                    <motion.div
                                        className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-red-accent/20 blur-[100px]"
                                ...
                                <div className="relative z-10 p-10 md:p-16 flex flex-col md:flex-row items-center gap-8 md:gap-12">
                                    ...
                                    <div className="text-center md:text-left flex-grow">
                                        <span className="text-red-accent text-sm uppercase tracking-[0.2em] font-semibold mb-3 block">
                                            Die andere Dimension
                                        </span>
                                        <h3 className="typ-h3 text-white mb-4">
                                            Eigentlich auf der Suche nach Orientierung im Kopf?
                                        </h3>
                                        <p className="text-white/80 text-lg leading-relaxed max-w-xl">
                                            Manchmal sitzt das Problem nicht im Körper, sondern tiefer. Entdecke meinen therapeutischen Ansatz für echte emotionale Klarheit.
                                        </p>
                                    </div>
