...
export const fr: Translations = {
  ...
  gestalttherapie: {
    scrollTelling: {
      ...
      intro: 'La Gestalt-thérapie est une approche thérapeutique humaniste basée sur trois piliers essentiels :',
      pillars: [
        {
          title: '1. Conscience',
          subtitle: 'Ressentir plutôt que penser',
          description: 'Percevoir consciemment le corps et les émotions. Être ancré dans le moment.',
        },
        {
          title: '2. Globalité',
    ...
    kontaktzyklus: {
      ...
      intro: 'Le cycle de contact décrit le rythme naturel du besoin et de l\'action – en six phases :',
      phases: [
        { title: '1. Sensation', subtitle: 'Corps', description: 'Percevoir un besoin intérieur' },
        { title: '2. Conscience', subtitle: 'Esprit', description: 'Prise de conscience et compréhension' },
        { title: '3. Mobilisation', subtitle: 'Action', description: 'Développer énergie et motivation' },
        { title: '4. Contact', subtitle: '', description: 'Expérience complète dans le moment' },
  ...
  angebot: {
    ...
    services: [
      {
        ...
        description: 'Nous dissolvons les anciens schémas là où ils sont nés : dans le contact et dans le corps. Au lieu d\'années à « en parler », nous utilisons l\'ici et maintenant pour rendre les blocages émotionnels tangibles et modifiables.',
      },
      {
        title: 'Coaching Holomotion',
        subline: 'CLARTÉ PAR L\'INTELLIGENCE CORPORELLE',
        description: 'La stratégie rencontre l\'intuition. Nous combinons la planification cognitive avec la sagesse de ton corps. Pour des décisions qui ne sonnent pas seulement logiques mais qui se sentent aussi justes au fond de toi.',
      },
      {
    ...
    konditionen: {
      title: 'Conditions & Collaboration',
      einzelbegleitung: {
        price: '50€',
