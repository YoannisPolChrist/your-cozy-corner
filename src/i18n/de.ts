...
export const de: Translations = {
  ...
  gestalttherapie: {
      ...
      pillars: [
        {
          ...
          description: 'Körper und Gefühle bewusst wahrnehmen. Im Moment verankert sein.',
        },
        {
          title: '2. Ganzheitlichkeit',
          subtitle: 'Körper, Seele, Geist & Umfeld',
          description: 'Alle Aspekte des Menschseins als untrennbare Einheit betrachten.',
        },
        {
          title: '3. Kontakt & Dialog',
    ...
    offeneGestalt: {
      ...
      description: 'Eine offene Gestalt ist ein unvollendetes Erlebnis – ein ungelöster Konflikt oder unterdrücktes Gefühl.',
      tagline: 'In der Therapie schließen wir diese Gestalten.',
    },
