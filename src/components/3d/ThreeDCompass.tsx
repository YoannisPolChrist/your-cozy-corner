...
export const CompassNeedle = () => {
    ...
    useFrame((state) => {
        ...
        if (needleRef.current) {
            // Interactive rotation towards mouse (simulating magnetism)
            // Interpolate towards the target for smoothness
    ...
    return (
        <group ref={groupRef} dispose={null}>
            ...
            >
                ...
                {/* Inner compass needle (Octahedron slightly elongated) */}
                <Octahedron ref={needleRef} args={[1.5, 0]}>
                    <meshPhysicalMaterial
                        color="#1E5F74" // Primary teal
                        metalness={0.7}
                        roughness={0.2}
