...
const PrincipleText = ({ principle, index, scrollProgress }: PrincipleTextProps) => {
...
const PrincipleCard = ({ principle, index, scrollProgress }: PrincipleCardProps) => {
  const startProgress = index * 0.33;
  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          boxShadow: "0 25px 80px -12px rgba(0, 0, 0, 0.5), 0 10px 30px -8px rgba(0, 0, 0, 0.3)",
        }}
      >
        {/* Card Image */}
        <img
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <p className="text-accent font-medium text-sm tracking-wider uppercase mb-1">
